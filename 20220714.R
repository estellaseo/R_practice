...
#5. 벡터 원소 추가 / 삭제
v1 <- 1:10                      #벡터 생성
v1 <- c(v1, 11)                 #벡터 원소 추가 방법 1
v1 <- append(v1, 12)            #벡터 원소 추가 방법 2
v1[length(v1) + 1] <- 13        #벡터 원소 추가 방법 3
...
1:10                                             #백터 리턴
'a':'c'                                          #불가
as.Date('2022/01/01'):as.Date('2022/12/31')      #제대로된 날짜 출력 X


#seq(from = 시작값, to = 끝값, by = 증가값)
seq(1, 100, 2)                                                   #가능
seq('a', 'c')                                                    #불가    
seq(as.Date('2022/01/01'), as.Date('2022/12/31'), by = 1 )       #가능
seq(as.Date('2022/01/01'), as.Date('2022/12/31'), by = 'week' )
seq(as.Date('2022/01/01'), as.Date('2022/12/31'), by = 'month' )
